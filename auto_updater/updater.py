...
TARGET_DIRS = [
    os.path.join(ROOT, "vaultweaver"),
    os.path.join(ROOT, "vaultweaver", "core"),
    os.path.join(ROOT, "vaultweaver", "graph"),
    os.path.join(ROOT, "vaultweaver", "exporters"),
    os.path.join(ROOT, "vaultweaver", "plugins"),
    os.path.join(ROOT, "vaultweaver", "utils"),
    os.path.join(ROOT, "vaultweaver", "tasks"),
    os.path.join(ROOT, "vaultweaver", "bookmarks"),
]
...
def choose_action_and_apply(snippets, targets):
    ...
    if snippets and random.random() < PROB_ADD:
        ...
        if name in blocks:
            new = replace_snippet(txt, name, code, blocks)
        else:
